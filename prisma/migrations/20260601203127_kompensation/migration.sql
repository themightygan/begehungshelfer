...
INSERT INTO "new_Befund" ("gutGemacht", "id", "notiz", "parzelleId", "plakettenNotiz", "rundeId", "snapAdresse", "snapPaechter", "snapParzelleId", "stufe", "zeitpunkt") SELECT "gutGemacht", "id", "notiz", "parzelleId", "plakettenNotiz", "rundeId", "snapAdresse", "snapPaechter", "snapParzelleId", "stufe", "zeitpunkt" FROM "Befund";
DROP TABLE "Befund";
