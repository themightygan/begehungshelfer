...
export default async function ParzelleSeite({
  ...
  return (
    <div className="space-y-5 pb-16">
      ...
      {/* Zwei Spalten auf großen Screens (iPad/Desktop), gestapelt am Handy */}
      <div className="grid gap-5 lg:grid-cols-2">
        {/* Linke Spalte: Mängel (Kernarbeit) */}
        <div className="space-y-5">
          {/* Mängel-Menü */}
          <section className={CARD}>
            <h2 className="text-base font-medium text-stone-600">Mangel hinzufügen</h2>
            <p className="text-sm text-stone-400">Antippen wählt den Punkt aus.</p>
                    ...
                    {b.punkte.map((k) =>
                      gewaehlt.has(k.id) ? (
                        ...
                        <button
                          ...
                          className="rounded-full border border-stone-300 bg-white px-3.5 py-2 text-sm hover:border-emerald-400 hover:bg-emerald-50"
                        >
                          {k.punkt}
                        </button>
                      )
        ...
        {/* Rechte Spalte: Gesamtansicht, Gemüsebeete, Akte */}
        <div className="space-y-5">
          {/* Gesamtansicht-Fotos */}
          <section className={CARD}>
      ...
      {/* Befund (Stufe + Bemerkung) + Speichern & weiter — volle Breite, am Ende */}
      <BefundForm
